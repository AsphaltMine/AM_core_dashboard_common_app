...
class DashboardWorkspaces(CommonView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        modals = [
            dashboard_constants.MODALS_COMMON_DELETE,
            "core_main_app/user/workspaces/list/modals/set_title.html",
        ]
        ...
        assets = {
            ...
            "js": [
                ...
                {
                    "path": "core_main_app/user/js/workspaces/list/modals/set_title.raw.js",
                    "is_raw": True,
                },
                {
                    "path": "core_main_app/user/js/workspaces/list/modals/set_title.js",
                    "is_raw": False,
                },
            ],
        }
